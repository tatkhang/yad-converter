 ...
 * {@link #then(Class)} method, and a default pipeline can be built using
 ...
 * 
 * <pre>
 * ConverterPipeline.buildDefault().run(data);
 * </pre>
 *
...
public class ConverterPipeline {
    ...
    /**
     * Builds and returns a default {@link ConverterPipeline} with a predefined
     * sequence of processing steps.
     *
     * @return The default pipeline includes the following steps in order:
     *         <ol>
     *         <li>{@link FileExtensionValidationStep} - Validates the file
     *         extension.</li>
     *         <li>{@link CsvToParquetConversionStep} - Converts CSV files to
     *         Parquet format.</li>
     *         <li>{@link ParquetToCsvConversionStep} - Converts Parquet files back
     *         to CSV format.</li>
     *         <li>{@link FallbackStep} - Handles any cases not covered by previous
     *         steps.</li>
     *         </ol>
     */
    ...
    /**
     * Starts a new {@link ConverterPipeline} with the specified first step class.
     ...
     */
    public static final <T extends IConvertPilelineStep> ConverterPipeline startWith(Class<T> clazz) {
        return new ConverterPipeline().then(clazz);
    }
    ...
    /**
     * Executes the converter pipeline starting from the first step using the
     * provided data.
     *
     * @param data the data object containing information required for the
     *             conversion process
     * @throws YadConverterException if an error occurs during the conversion
     *                               pipeline execution
     */
