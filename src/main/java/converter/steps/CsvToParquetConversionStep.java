...
public class CsvToParquetConversionStep implements IConvertPilelineStep {
     ...
     */
    private static Schema inferAvroSchemaFromCsv(List<String> headers, List<CSVRecord> records) {
     ...
     * @implNote Support primitive data types only
     */
    private static Object convertValueToAvroField(Object value, Schema avroSchema) throws YadConverterException {
